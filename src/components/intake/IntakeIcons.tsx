...
export const IIcon = {
  ...
  sparkle: ({ s = 16 }: P) => <svg width={s} height={s} viewBox="0 0 16 16" fill="currentColor"><path d="M8 3.5c.4 2.7 1.8 4.1 4.5 4.5C9.8 8.4 8.4 9.8 8 12.5 7.6 9.8 6.2 8.4 3.5 8 6.2 7.6 7.6 6.2 8 3.5Z"/></svg>,
